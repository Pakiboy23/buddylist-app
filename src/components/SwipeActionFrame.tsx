...
export default function SwipeActionFrame({
  ...
  return (
    <div className={`relative ${className}`} style={{ touchAction: 'pan-y' }}>
      ...
      >
        <div
          className="inline-flex items-center gap-1.5 rounded-full border border-blue-200/55 bg-blue-500/12 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-blue-500 dark:border-blue-400/25 dark:bg-blue-400/12 dark:text-blue-200"
