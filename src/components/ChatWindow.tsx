    ...
    if (kind === 'image') {
      return (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="ui-focus-ring block overflow-hidden rounded-[1rem] border border-white/30 bg-[#0F1424]/5"
    ...
    if (kind === 'video') {
      return (
        <video
          ...
          preload="metadata"
          playsInline
          className="block max-h-64 w-full rounded-[1rem] border border-white/30 bg-[#0F1424]/20"
          src={data.publicUrl}
        />
      );
    }
