-- First-pass invite_to_room RPC. Superseded by 20260418071643 which adds an
-- execute grant and tweaks the error path. Imported retroactively from
...
begin
  ...
  if exists (
    ...
    raise exception 'User is already in this room';
  end if;
