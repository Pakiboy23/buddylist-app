-- Second-pass invite_to_room RPC. Adds an execute grant, treats an already-
-- joined invitee as a no-op instead of erroring, and rewords the not-a-member
-- error. Imported retroactively from production migrations table.
