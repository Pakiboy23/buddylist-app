    ...
    scenes: [
      {
        ...
        detail: 'Hide previews, enable screen shielding, and control what H.I.M. reveals.',
        accentStart: '#818cf8',
        accentEnd: '#22d3ee',
        touch: { x: 0.82, y: 0.23 },
        motion: {
      ...
      },
      {
        ...
        detail: 'Add a local lock and choose exactly how quickly H.I.M. asks again.',
        accentStart: '#60a5fa',
        accentEnd: '#34d399',
        touch: { x: 0.5, y: 0.78 },
        motion: {
